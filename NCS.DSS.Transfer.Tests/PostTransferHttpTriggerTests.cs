...
namespace NCS.DSS.Transfer.Tests
{
    ...
    public class PostTransferHttpTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _function = new PostTransferHttpTrigger.Function.PostTransferHttpTrigger(_resourceHelper.Object, _httpRequestMessageHelper.Object, _validate, _postTransferHttpTriggerService.Object);
        }
        ...
        public async Task PostTransferHttpTrigger_ReturnsStatusCodeUnprocessableEntity_WhenTransferHasFailedValidation()
        {
            ...
            _httpRequestMessageHelper.Setup(x => x.GetTouchpointId(_request)).Returns("0000000001");
            _httpRequestMessageHelper.Setup(x => x.GetApimURL(_request)).Returns("http://localhost:7071/");
            _httpRequestMessageHelper.Setup(x=>x.GetTransferFromRequest<Models.Transfer>(_request)).Returns(Task.FromResult(_transfer));
            ...
            _function = new PostTransferHttpTrigger.Function.PostTransferHttpTrigger(_resourceHelper.Object, _httpRequestMessageHelper.Object, val.Object, _postTransferHttpTriggerService.Object);
